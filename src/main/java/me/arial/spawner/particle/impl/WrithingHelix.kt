...
class WrithingHelix (
    ...
    override fun clone(): Particle {
        if (ser) return WrithingHelix(map, true)
        return WrithingHelix(map)
    }

    override fun getType(): ParticleType {
        return ParticleType.WRITHING_HELIX
    }
    ...
    companion object {
        fun deserialize(map: Map<String, Any>): Particle {
            val helix = WrithingHelix(map, true)
